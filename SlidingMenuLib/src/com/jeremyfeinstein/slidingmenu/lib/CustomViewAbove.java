...
import com.jeremyfeinstein.slidingmenu.lib.SlidingMenu.OnScrowViewListener_m;
...
//到左侧的距离
	...
	public void setOnScrowViewListener(OnScrowViewListener_m l) {mScrowViewListener = l;}
	...
	private void pageScrolled(int xpos) {
		...
		if(mScrowViewListener!=null) {
			mScrowViewListener.onScrow((int)(offset*100), offsetPixels, (int)leftoffset);
		}
