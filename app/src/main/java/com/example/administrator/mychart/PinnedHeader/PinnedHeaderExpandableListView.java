package com.example.administrator.mychart.PinnedHeader;
...
public class PinnedHeaderExpandableListView extends ExpandableListView implements OnScrollListener,OnGroupClickListener {
    ...
    private void init()
    {
        ...
        //分割线
        this.setDivider(new ColorDrawable(getResources().getColor(R.color.gray)) );
    ...
    public void setHeaderData(int groupPosition)
    {
        ...
        String[] childrenData = mAdapter.childrenData[groupPosition];
        ((TextView) mHeaderView.findViewById(R.id.groupto)).setText(/*"- "+*/groupData+"");
        ((TextView) mHeaderView.findViewById(R.id.tv_groutp_count)).setText("1/"+childrenData.length);
        ((View) mHeaderView.findViewById(R.id.view_line)).setVisibility(VISIBLE);
        //((ImageView) mHeaderView.findViewById(R.id.iv_group)).setImageResource(R.mipmap.v5_expander_open_light);
    ...
    public void setAdapter(ExpandableListAdapter adapter) {
        ...
        mAdapter = (ContactListAdapter) adapter;
    }
